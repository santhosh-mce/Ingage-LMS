...
public class Career {
    ...
    @Column(name = "price")
    private Double price = 14999.0;

    @Column(name = "original_price")
    private Double originalPrice = 24999.0;

    @Column(name = "discount_percent")
    private Integer discountPercent = 40;
    ...
    public Double getPrice() { return price != null ? price : 14999.0; }
    public void setPrice(Double price) { this.price = price; }

    public Double getOriginalPrice() { return originalPrice != null ? originalPrice : 24999.0; }
    public void setOriginalPrice(Double originalPrice) { this.originalPrice = originalPrice; }

    public Integer getDiscountPercent() { return discountPercent != null ? discountPercent : 40; }
