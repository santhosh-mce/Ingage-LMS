...
public class AdminCourseController {
    ...
    public ResponseEntity<List<Map<String, Object>>> getCourses(
        ...
        return ResponseEntity.ok(courseService.getAllCourses(search, status, category));
    }
    ...
    @org.springframework.web.bind.annotation.RequestMapping(value = "/courses/{id}/publish", method = {org.springframework.web.bind.annotation.RequestMethod.POST, org.springframework.web.bind.annotation.RequestMethod.PATCH})
    ...
    @org.springframework.web.bind.annotation.RequestMapping(value = "/courses/{id}/unpublish", method = {org.springframework.web.bind.annotation.RequestMethod.POST, org.springframework.web.bind.annotation.RequestMethod.PATCH})
