...
import { getCourseContent, createPaymentOrder, verifyPayment, validateCoupon, CourseContentDetail } from '../api/paymentApi';
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-200/80 shadow-xs">
              <div className="flex flex-wrap items-center gap-2 mb-4">
                <span className="px-3 py-1 bg-lime-100 text-lime-800 rounded-full text-xs font-bold tracking-wide uppercase">
                  {course.level} Level
                </span>
                ...
                {course.isEnrolled && (
                  <span className="px-3 py-1 bg-emerald-500 text-white rounded-full text-xs font-bold flex items-center gap-1 shadow-xs">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 tracking-tight mb-4">
                {course.title}
              </h1>
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                <div className="w-10 h-10 rounded-full bg-linear-to-br from-lime-400 to-emerald-500 flex items-center justify-center text-white font-bold text-sm shadow-xs">
                  {course.instructor ? course.instructor.charAt(0) : 'I'}
                </div>
                <div>
                  <div className="text-xs text-gray-400 font-medium">Course Instructor</div>
                  <div className="text-sm font-bold text-gray-900">{course.instructor || 'Lead Technical Mentor'}</div>
                </div>
              </div>
            </div>
                  ...
                  course.sections.map((section, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <div>
                            <div className="text-xs font-bold text-lime-700 uppercase tracking-wider mb-0.5">
                              Module {idx + 1}
                            </div>
            ...
            <div className="bg-white rounded-3xl p-6 border border-gray-200/80 shadow-md lg:sticky lg:top-20 space-y-6">
              ...
              <div>
                ...
                {!isFree && appliedCoupon && (
                  <div className="mt-2 text-xs font-bold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-lg flex items-center justify-between border border-emerald-200/60">
              ...
              {/* Coupon Input Box (Only for paid & not enrolled) */}
              ...
              <div className="pt-2">
                {course.isEnrolled ? (
                  <button
                    onClick={() => onNavigate(`/learn/${course.slug || course.id}`)}
                    className="w-full py-4 bg-linear-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-bold rounded-2xl shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer"
                  >
