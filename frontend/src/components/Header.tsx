          ...
          >
            ...
            {exploreMenuOpen && (
              <div
                ...
                className="absolute left-0 mt-2 w-[calc(100vw-2rem)] sm:w-[94vw] lg:w-[980px] xl:w-[1040px] max-w-[1040px] bg-white rounded-2xl shadow-2xl border border-gray-200 p-4 sm:p-6 z-50 animate-in fade-in zoom-in-95 duration-150 max-h-[85vh] overflow-y-auto"
              >
