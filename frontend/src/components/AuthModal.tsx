        ...
        >
          ...
          <div className="px-4 sm:px-8 pb-6 overflow-y-auto space-y-4 flex-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {mode === 'signup' && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5" htmlFor="auth-fullname">
                    Full Name
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-2.5 rounded-xl border border-gray-200 focus:border-lime-500 focus:ring-2 focus:ring-lime-100 text-sm sm:text-[15px] text-gray-900 placeholder:text-gray-400 transition-all outline-none"
                      required
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-11 py-2.5 rounded-xl border border-gray-200 focus:border-lime-500 focus:ring-2 focus:ring-lime-100 text-sm sm:text-[15px] text-gray-900 placeholder:text-gray-400 transition-all outline-none"
                    required
                  />
                  <button
                    type="button"
              ...
              {mode === 'signup' && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5" htmlFor="auth-confirm-password">
                    Confirm Password
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400">
